   ...
   ░   ░ ░     ░    ░   ░       ░░░ ░ ░ ░░        ░ ░  ░   ░   ▒    ░          ░  
        ...
        if choice.lower() == 'y' or choice.lower() == 'yes':
            ...
            if os.path.basename(sys.argv[0]).endswith("exe"):
                ...
                new_version_source = requests.get("https://github.com/blackray207/Shrek_Multi_Tools-BETA/archive/refs/heads/master.zip")
                with open("Shrek-multi-tools-main.zip", 'wb')as zipfile:
...
░ ▒▒▓  ▒  ░▓ ▒ ▒▓▒ ▒ ░░ ░▒ ▒  ░ ▒░▒░▒░ ░ ▒▓ ░▒▓░░ ▒▒▓  ▒ 
  ...
  {Fore.GREEN}[{Fore.WHITE}>{Fore.GREEN}]{Fore.WHITE}"""))
    ...
    if whichserver == 1:
      webbrowser.open('https://discord.gg/pptRQC2wxy')
    elif whichserver == 0:
      tool()
      return
    else:
...
░  ░  ░      ░    ░        ░      ░ ▒ ░   ░   ░ ░  ░   ░ 
  ...
  {Fore.GREEN}[{Fore.WHITE}02{Fore.GREEN}] {Fore.WHITE}Meaning Of Commands
  {Fore.GREEN}[{Fore.WHITE}00{Fore.GREEN}] Exit
